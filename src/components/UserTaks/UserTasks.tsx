...
export const UserTasks = () =>{
    const {userTasks, openCreateTask,onCancelModal, onClickCreateTask} = useUserTasks();
...
{/*        user table*/}
        ...
        <div onClick={onClickCreateTask}>create tasks</div>
        ...
        <TaskModification open={openCreateTask} onCancel={onCancelModal}  />
    </div>)
}
